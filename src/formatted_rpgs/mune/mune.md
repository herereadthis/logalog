...
Or MUNE for short. Pdf displaying weirdly? grab the homebrewery page here. https://homebrewery.naturalcrit.com/share/rkmo0t9k4Q
...
**Entity Positive/Entity Negative.** Something good or bad happens to an entity, the specifics of which can be determined by asking the oracle (with some optional help from a Portent).
...
Any random word generator will suffice for this. There are tonnes of these online (https://wordcounter.net/random-word-generator). I generally have a two-word generation limit, because I find that any more starts to get kinda messy, but you do you.
...
* A brand new session, new characters, new plot: https://empaitirkosu.wordpress.com/2020/03/07/raid-in-rahm-oru/
* A more combat-focused but higher level session: https://empaitirkosu.wordpress.com/2018/07/25/blow-by-blow-session-intro/